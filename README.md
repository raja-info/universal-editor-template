...
## Environments
- Preview: https://main--universal-editor-template--raja-info.aem.page/
- Live: https://main--universal-editor-template--raja-info.aem.live/
...
1. Open the `universal-editor-template` directory in your favorite IDE and start coding :)
